<!-- EXPECT: W4 -->
<!-- WHY: 只犯一种错：来源换成内容农场，可达且数字对得上，只是不是一手。 -->
# 依恋类型测试要多久
...
共 36 项，采用 7 点计分（<a href="https://weak-aggregator.test/ecr-copy">来源：ECR 原始量表说明</a>）。</p>
<p>题量和时间的关系是线性的：题目每减少 12 道，平均用时下降约 3 分钟。我们在 2026 年 7 月
对 1200 名用户计时，中位数为 9.4 分钟，第 90 百分位为 14 分钟
（<a href="https://weak-aggregator.test/timing-copy">来源：本站 2026 年 7 月计时数据</a>）。</p>
